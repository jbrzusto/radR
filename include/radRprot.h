...
SEXP radR_find_patches(SEXP classsxp, SEXP usediagsxp, SEXP patchessxp, SEXP skipsxp, SEXP wrapsxp);
SEXP radR_process_patches(SEXP filtersxp, SEXP scansxp, SEXP scoresxp, SEXP classsxp, SEXP patchbuff, SEXP statssxp, SEXP sampnumrange, SEXP arearange, SEXP angularrange, SEXP radialrange, SEXP rangeelevpersample, SEXP areaweighting, SEXP scaninfo, SEXP pulses, SEXP rectangular, SEXP origin);
