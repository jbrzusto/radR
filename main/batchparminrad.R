...
## batchparminrad.R:  parameter file for batch runs generating blips and blipmovies
## from inradarch files
...
################################################################################
###
###  Antenna: just specify an antennafile
################################################################################

      antenna = "antennas/default.antenna.R",
