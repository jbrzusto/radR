...
## will cause the files "NAME.plugin.R" and "NAME.conf.R" to be loaded

plugins.to.load = c("zone", "blipmovie", "antenna", "tracker", "bliptrails", "help", "comments", "pointerinfo", "generic", "rawarch", "underlay", "gifmovie")
