## svn $Id: default-tbar.antenna.R 574 2010-05-11 02:07:15Z john $
##
...
antenna.desc = "Default open array antenna.  You can use the antenna plugin to customize this." 
