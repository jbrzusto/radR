...
mode.table.string = "
      ...
      PRF.Hz  PLEN.ns   NPULSE   RES.m    NCELL        ##   RANGE.m   MEGABYTES
                                                       ##
 1     3000     70       4096     2.5      256         ##      640        2   
 2     3000     70       4096     2.5      512         ##     1280        4        
 3     3000     70       4096     2.5      768         ##     1920        6       
 4     3000     70       4096     2.5     1024         ##     2560        8        
 5     3000     70       4096     5.0      256         ##     1280        2        
 6     3000     70       4096     5.0      512         ##     2560        4        
 7     3000     70       4096     5.0      768         ##     3840        6        
 8     3000     70       4096     5.0     1024         ##     5120        8   
 9     3000     70       4096     7.5      256         ##     1920        2        
10     3000     70       4096     7.5      512         ##     3840        4       
11     3000     70       4096    15.0      256         ##     2560        2   
12     3000     70       4096    15.0      512         ##     5120        4   
13     1500    300       3072     5.0      256         ##     1280        1.5 
14     1500    300       3072     5.0      512         ##     2560        3   
15     1500    300       3072     5.0      768         ##     3840        4.5 
16     1500    300       3072     5.0     1024         ##     5120        6   
17     1500    300       3072     5.0     1280         ##     6400        7.5 
18     1500    300       3072    15.0      256         ##     2560        1.5 
19     1500    300       3072    15.0      512         ##     5120        3   
20     1500    300       3072    15.0      768         ##     7680        4.5 
21     1500    300       3072    15.0     1024         ##    10240        6   
22     1500    300       3072    15.0     1280         ##    12800        7.5 
23      600   1200       1536     5.0      256         ##     1280        0.75
24      600   1200       1536     5.0      512         ##     2560        1.5 
25      600   1200       1536     5.0      768         ##     3840        2.25
26      600   1200       1536    15.0      512         ##     5120        1.5 
27      600   1200       1536    15.0      768         ##     7680        2.25
28      600   1200       1536    15.0     1024         ##    10240        3   
29      600   1200       1536    20.0      512         ##    10240        1.5 
30      600   1200       1536    20.0      768         ##    15360        2.25
31      600   1200       1536    20.0     1024         ##    20480        3   
...
## The Furuno 2124 has these nominal PRFs:  3000, 1500, 1000, 600, 500
## and these pulse lengths: 70, 150, 300, 500, 700, 1200 nanoseconds
##
## The table of PRF/PLEN available by radar range setting is:
## (starred values indicate settings to be used with radR for short, medium, and long pulse modes)
##  Range    PRF    PLEN
##   (nm)    (Hz)   (ns)
##   0.125   3000     70 (* short)
##   0.25    3000     70
