...
/* OCRAD_Pixmap.data is a pointer to image data formed by "height" rows
   ...
   OCRAD_colormap32 --> 4 bytes per pixel;  upper 8 bits ignored; lower 24 bits: RGB */

  enum OCRAD_Pixmap_Mode { OCRAD_bitmap, OCRAD_greymap, OCRAD_colormap, OCRAD_colormap32 };
