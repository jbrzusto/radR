...
available.modes = c("last N scans", "storage tube", "raw tube")

## the currently selected mode
current.mode = "last N scans"

## path to the folder where thumbnails are stored
thumbnail.folder = "./thumbnails"

## prefix for thumbnail filenames
thumbnail.prefix = "thumbnail_"

## the duration (in seconds) after which to snapshot the plot and reset the
## stored data (if mode is `max tube`)
