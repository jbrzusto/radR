## svn $Id: pointerinfo.conf.R 574 2010-05-11 02:07:15Z john $
##                                                         
...
formatter = list ( 
  range.bearing = function (rb) {
    sprintf("range: true=%7.3f km, ground=%7.3f km; bearing=%5.1f deg", rb[2]/1000, rb[1]/1000, rb[3])
  },
...
clipboard.formatter = list ( 
  range.bearing = function (rb) {
    sprintf("%.3f\t%.3f\t%.3f", rb[2]/1000, rb[1]/1000, rb[3])
  },
